        ...
        >
          <div className="flex items-center justify-center lg:justify-start gap-3 mb-6">
            ...
            <span className="text-[11px] font-bold tracking-[0.25em] uppercase text-primary"
              style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>We’re Hiring</span>
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-[3.2rem] xl:text-6xl font-black leading-[1.05] text-[#1a1a1a]!"
            style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
            <span className="text-primary">Build Your Future</span>
            <br className="hidden sm:block" /> with Houston’s Trusted
            <br className="hidden sm:block" /> Petroleum &amp; Environmental Partner
          </h1>
          ...
          <p className="text-[#555] text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0"
            ...
            Join a <span className="font-semibold text-[#1a1a1a]">35+ year</span> industry leader in petroleum infrastructure
            and environmental compliance. Real careers. Real growth. Real impact.
          </p>
        ...
        >
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              { value: "Now", label: "Actively Hiring" },
            ].map((s, i) => (
              <motion.div key={i}
          ...
          >
            ...
            <div className="px-5 py-4">
              <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#aaa] mb-2"
                style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>Open Departments</p>
              <div className="flex flex-wrap gap-2">
                {["Field Operations", "Manufacturing", "Environmental", "Compliance", "Construction", "Logistics"].map((tag) => (
                  <span key={tag}
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 py-4
          ...
          <p className="text-white text-sm font-bold uppercase tracking-wider text-center sm:text-left"
            style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
            Careers in Petroleum, Environmental &amp; Construction — Houston, TX
          </p>
          <div className="flex items-center gap-3 shrink-0">
            <div className="h-px w-8 bg-white opacity-30" />
            <span className="text-white text-[10px] uppercase tracking-widest opacity-70">Grow · Lead · Belong</span>
          </div>
        </div>
      </motion.div>
    </section>
