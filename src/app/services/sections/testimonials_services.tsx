...
const TESTIMONIALS = [
  {
    ...
    location: "Houston, TX",
    text: "Geo Petroleum provided end-to-end service for our new site — from tank manufacturing to canopy installation and compliance documentation. Every phase was handled professionally, and the results were top-tier.",
  },
];

const Testimonial_Services: React.FC = () => {
          ...
          <div className="relative border border-[#d8d8d8] bg-[#fafaf8] p-1 shadow-sm">
            ...
            <div className="px-8 sm:px-12 pt-10 pb-8">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <p
                    className="text-lg sm:text-xl text-[#333] leading-relaxed mb-8 italic"
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p
                        className="text-[12px] font-black uppercase tracking-[0.15em] text-[#1a1a1a]"
                        style={{
                      ...
                      <p
                        className="text-[11px] uppercase tracking-[0.15em] text-primary font-bold mt-0.5"
                        style={{
                          fontFamily: "var(--font-montserrat), sans-serif",
                        }}
                      >
