    ...
    <section className="relative overflow-hidden bg-[#f5f4f0] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image
          ...
          fill
          priority
          className="object-cover object-center opacity-40 hidden lg:block"
        />
      </div>
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16
        ...
        >
          ...
          <h1
            className="text-4xl sm:text-5xl lg:text-[3rem] xl:text-6xl font-black leading-[1.05] text-[#1a1a1a]!"
            style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
          >
            <span className="text-primary">Environmental Risk Assessments</span>
            &nbsp;That Protect Your Site, Investment, and Reputation
          </h1>
          ...
          <div className="space-y-4 text-[#555] text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0"
            ...
            <p>
              With <span className="font-semibold text-[#1a1a1a]">35+ years of experience</span> in petroleum
              systems and environmental safety, <span className="font-semibold text-[#1a1a1a]">Geo Petroleum</span> helps
              businesses across <span className="font-semibold text-[#1a1a1a]">Houston, Texas, and the Southeast</span> identify,
              manage, and mitigate environmental risks before they become costly problems.
            </p>
            <p>
              Our <span className="font-semibold text-[#1a1a1a]">environmental consultants in Houston</span> combine
              field-tested expertise with data-driven analysis to help you maintain compliance, protect assets,
              and safeguard your community.
            </p>
          </div>
        </motion.div>

        {/* RIGHT: Stats + compliance badge */}
        <motion.div
          initial={{ opacity: 0, x: 30 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              { value: "Phase I–III", label: "Full ESA Coverage" },
              ...
              >
                ...
                <span
                  className="block text-2xl font-black text-primary leading-none mb-1"
                  style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
                >
                  {s.value}
                </span>
          ...
          >
            ...
            <div className="px-5 py-4">
              <p
                className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#aaa] mb-2"
                style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
              >
                Compliance Standards Met
              </p>
              <div className="flex flex-wrap gap-2">
                {["EPA", "TCEQ", "Phase I ESA", "Phase II ESA", "SPCC", "LPST"].map((tag) => (
                  <span
                    key={tag}
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 py-4
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
          >
            Trusted Environmental Risk Experts Across Texas &amp; the Southeast
          </p>
