...
const TESTIMONIALS = [
  {
    name: "Sara L.",
    company: "Fuel Distributor",
    location: "Houston, TX",
    text: "Geo Petroleum’s compliance experts handled our site inspections and permitting from start to finish. They identified potential issues before our audit and kept us fully compliant — saving us time and stress.",
  },
];

const Testimonial_ECS: React.FC = () => {
...
export default Testimonial_ECS;