  ...
  return (
    <section className="relative overflow-hidden bg-[#f5f4f0] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image src="/images/services/ECS/Hero_ECS.webp" alt="Environmental Compliance Solutions"
        ...
        >
          <div className="flex items-center justify-center lg:justify-start gap-3 mb-6">
            ...
            <span className="text-[11px] font-bold tracking-[0.25em] uppercase text-primary"
              style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>Environmental Services</span>
          </div>
          <h1 className="text-3xl sm:text-5xl xl:text-6xl font-black leading-[1.05] text-[#1a1a1a]!"
            style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
            <span className="text-primary">Environmental Compliance Solutions</span>
            &nbsp;That Protect Your Business and the Environment
          </h1>
          ...
          <div className="space-y-4 text-[#555] text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0"
            ...
            <p>With <span className="font-semibold text-[#1a1a1a]">35+ years of experience</span> helping petroleum
              businesses stay compliant, <span className="font-semibold text-[#1a1a1a]">Geo Petroleum</span> provides
              trusted environmental compliance solutions in Houston and across Texas.</p>
            <p>Our <span className="font-semibold text-[#1a1a1a]">certified environmental consultants</span> work closely
              with fuel retailers, industrial operators, and municipalities to ensure every site meets{" "}
              <span className="font-semibold text-[#1a1a1a]">EPA, TCEQ, and state-level regulations</span> — without
              stress or surprises.</p>
          </div>
        </motion.div>
        ...
        >
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              { value: "EPA+TCEQ", label: "Standards Met" },
          ...
          >
            ...
            <div className="px-5 py-4">
              <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#aaa] mb-2"
                style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>Compliance Coverage</p>
              <div className="flex flex-wrap gap-2">
                {["EPA", "TCEQ", "UST Testing", "AST Testing", "SPCC", "Permitting", "Remediation"].map((tag) => (
                  <span key={tag}
                    className="text-[11px] font-bold px-2.5 py-1 border border-primary/30
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 py-4
          ...
          <p className="text-white text-sm font-bold uppercase tracking-wider text-center sm:text-left"
            style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
            Inspection-Ready Compliance Solutions Across Texas &amp; the Southeast
          </p>
          <div className="flex items-center gap-3 shrink-0">
            <div className="h-px w-8 bg-white opacity-30" />
            <span className="text-white text-[10px] uppercase tracking-widest opacity-70">Licensed · Certified · Insured</span>
          </div>
        </div>
      </motion.div>
    </section>
