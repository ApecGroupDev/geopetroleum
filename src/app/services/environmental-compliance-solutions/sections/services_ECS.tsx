...
const SERVICES = [
  { icon: Wrench, num: "01", title: "Fuel System Inspections and Leak Detection" },
  { icon: ClipboardCheck, num: "02", title: "UST and AST Testing and Certification" },
  { icon: FileText, num: "03", title: "Compliance Documentation and Reporting" },
  { icon: ShieldCheck, num: "04", title: "Permitting and Liaison with Regulatory Agencies" },
  { icon: AlertTriangle, num: "05", title: "Spill Prevention and Control Program Design" },
  { icon: LifeBuoy, num: "06", title: "Emergency Response and Environmental Remediation" },
];
      ...
      <div className="relative max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-tight text-[#1a1a1a]!"
            ...
            Our <span className="text-primary">Environmental Compliance Services</span> Include
          </h2>
        ...
        >
          ...
          <p className="px-8 py-6 text-[15px] text-[#444] leading-relaxed text-center"
            ...
            Our <span className="font-semibold text-primary">environmental consultants in Houston</span> specialize
            in simplifying compliance for complex operations — ensuring you stay ahead of inspections, deadlines, and
