...
const AUDIENCES = [
  { icon: Fuel, label: "Fuel Station Owners & Operators" },
  { icon: Factory, label: "Petroleum & Environmental Contractors" },
  { icon: Wrench, label: "Tank Manufacturers & Installation Specialists" },
  { icon: Store, label: "C-Store & Retail Fueling Site Managers" },
  { icon: ShieldCheck, label: "Compliance, Inspection & Safety Professionals" },
  { icon: Truck, label: "Fleet Operators & Petroleum Investors" },
];
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="text-[11px] font-bold tracking-[0.25em] uppercase text-primary"
              style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>Who It’s For</span>
            <div className="h-px w-8 bg-primary" />
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-tight text-[#1a1a1a]!"
            style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
            Who Should Read <span className="text-primary">This Blog?</span>
          </h2>
          ...
          <p className="mt-5 text-[#555] text-base sm:text-lg leading-relaxed"
            ...
            <span className="font-semibold text-[#1a1a1a]">operate smarter and safer.</span>
          </p>
        </motion.div>
          ...
          {AUDIENCES.map(({ icon: Icon, label }, i) => (
            ...
            >
              ...
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <h3 className="text-[13px] font-black text-[#1a1a1a]! group-hover:text-primary transition-colors duration-300 leading-snug"
                  style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>{label}</h3>
              </div>
            </motion.div>
          ))}
        </div>
