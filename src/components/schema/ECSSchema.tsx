    ...
    "@graph": [
      {
        ...
        name: "Geo Petroleum",
        url: "https://www.geopetroleum.com/services/environmental-compliance-solutions",
        ...
        mainEntityOfPage: {
          "@type": "WebPage",
          "@id":
            "https://www.geopetroleum.com/services/environmental-compliance-solutions",
        },
      },
      {
        "@type": "Service",
        "@id": "https://www.geopetroleum.com#environmentalComplianceService",
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "We work with fuel retailers, fleet operators, distributors, and industrial clients throughout Houston and the Southeast.",
            },
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Yes — we manage all reports, permits, and documentation so your site stays 100% compliant and inspection-ready.",
            },
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Absolutely. We create prevention systems, emergency response plans, and cleanup strategies for fast recovery.",
            },
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Yes — our Houston-based experts know TCEQ, EPA, and local compliance standards inside and out.",
            },
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Yes — our certified technicians perform full UST and AST testing, including leak detection and integrity evaluations.",
            },
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Unlike most environmental companies in Houston, TX, Geo Petroleum offers full-service compliance management, tank testing, and remediation under one trusted provider.",
            },
          },
        ],
      },
