    ...
    "@graph": [
      {
        ...
        name: "Geo Petroleum",
        url: "https://www.geopetroleum.com/services/environmental-risk-assessment",
        ...
        mainEntityOfPage: {
          "@type": "WebPage",
          "@id":
            "https://www.geopetroleum.com/services/environmental-risk-assessment",
        },
      },
      {
        "@type": "Service",
        "@id": "https://www.geopetroleum.com#environmentalRiskAssessment",
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "An environmental risk assessment identifies and evaluates environmental hazards such as leaks, contamination, and compliance risks to prevent costly damage.",
            },
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Yes — Geo Petroleum evaluates USTs and ASTs for safety, corrosion, and leak prevention per EPA and TCEQ standards.",
            },
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Yes — we offer Phase I and II environmental site assessments to evaluate property conditions before purchase or development.",
            },
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "Yes — our certified environmental consultants in Houston provide local expertise, ensuring compliance with all Texas and federal regulations.",
            },
          },
        ],
      },
